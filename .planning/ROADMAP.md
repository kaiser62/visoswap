...
- [x] 01-04-PLAN.md — De-Qt `frame_worker.py`, close the gate on the whole tree, confirm in a Qt-free virtualenv
...
- [x] 04-03-PLAN.md — Model bootstrap: manifest, verify/repair, startup refusal (criteria 2 & 3)
- [x] 04-04-PLAN.md — Sever VisoMaster install dependency; no-VisoMaster proof (ENGINE-01 closed)
...
- [x] 05.1-03-PLAN.md — Backend media surface II: single-frame preview endpoint, timestamped take naming, takes gallery API with range streaming (D-09/D-12/D-10)
...
- [x] 05.1-05-PLAN.md — Live overlay: client frame index + binary search, informational WebSocket with refetch-on-open, player with nearest-previous overlay that never stalls the video (D-06/D-08/D-15d)
- [x] 05.1-06-PLAN.md — Media card, face library UI, generation modes + auto-preview (D-03/D-04/D-05/D-07/D-08/D-09)
- [x] 05.1-07-PLAN.md — Periphery: jobs/cadence card with honest coverage metric, results card, gallery view as a CSS-hidden toggle (D-10/D-15d/D-01)
- [x] 05.1-08-PLAN.md — Perf ladder rung b: make processing_scale/width reach the engine, bench it on an idle card, e2e spec + phase-close human verify (D-15b/D-15c)
...
| 05.1. Studio Frontend Media Workspace | 8/8 | Complete | 2026-09-21 |
