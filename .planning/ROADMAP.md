...
**Plans**: 4 plans
- [ ] 01-01-PLAN.md — Package skeleton, GPLv3 licensing, and the Qt-reachability gate proven on one tracer module
- [ ] 01-02-PLAN.md — Vendor the Qt-free bulk of `app/processors/` plus `visoswap/models/`, rewriting `app.*` imports
...
|-------|----------------|--------|-----------|
| 1. Vendor the Engine & Strip Qt | 0/4 | Not started | - |
