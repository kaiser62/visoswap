...
class CLIPDensePredT(CLIPDenseBase):
    ...
    def __init__(self, version='ViT-B/32', extract_layers=(3, 6, 9), cond_layer=0, reduce_dim=128, n_heads=4, prompt='fixed', 
        ...
        if fix_shift:
            ...
            self.shift_vector = nn.Parameter(torch.load(join(dirname(basename(__file__)), 'shift_text_to_vis.pth'), weights_only=True), requires_grad=False)  # VisoSwap: weights_only added (T-02-12); not upstream text.
